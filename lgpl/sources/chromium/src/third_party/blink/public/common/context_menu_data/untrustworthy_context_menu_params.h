...
struct BLINK_COMMON_EXPORT UntrustworthyContextMenuParams {
  ...
  // This is the post data including the %s search tag when the "Add as search
  // engine..." option is clicked on the input of the form that uses POST
  // method. Left empty otherwise. If set, keyword_url does not contain the %s
  // tag.
