...
class WebLocalFrame : public WebFrame {
 public:
  ...
  // Return the URL of the currently running script or the script that generated
  // it.
  virtual WebString IndirectScriptSourceUrl() const = 0;
  ...
  virtual void SetUserScrollDelta(const gfx::PointF&) {}
  ...
  // Save to PDF.
  virtual void PaintContentsForPDF(cc::PaintCanvas*, gfx::Rect) = 0;
