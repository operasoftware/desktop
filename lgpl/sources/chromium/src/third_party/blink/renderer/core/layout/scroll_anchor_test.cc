...
class ScrollAnchorTestWithParam : public ScrollAnchorTest,
...
INSTANTIATE_TEST_SUITE_P(, ScrollAnchorTestWithParam, testing::Bool());

TEST_P(ScrollAnchorTestWithParam, AnchorWhileDraggingScrollbar) {
