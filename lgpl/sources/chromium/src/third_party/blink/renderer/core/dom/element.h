...
class CORE_EXPORT Element : public ContainerNode, public Animatable {
 ...
 public:
  ...
  // Similar to innerText() but the result includes texts from open shadow DOMs.
  // The implementation is found in "element_inner_text.cc".
  String innerTextWithShadowDom();
