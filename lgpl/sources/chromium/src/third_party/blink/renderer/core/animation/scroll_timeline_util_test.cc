...
StringOrScrollTimelineElementBasedOffset OffsetFromString2(const String& value) {
...
TEST_F(ScrollTimelineUtilTest, ToCompositorScrollTimeline) {
  ...
  options->setStartScrollOffset(OffsetFromString2("50px"));
  options->setEndScrollOffset(OffsetFromString2("auto"));
