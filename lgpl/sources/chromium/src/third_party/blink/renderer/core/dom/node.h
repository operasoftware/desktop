...
enum class SelectionStartPolicy {
  // Uses element's default policy.
  kDefault,
  // By default, links override default selection policy. This option enables
  // default policy also for links.
  kDefaultAlsoForLinks,
};
...
class CORE_EXPORT Node : public EventTarget {
 ...
 public:
  ...
  virtual bool CanStartSelection(SelectionStartPolicy) const;
