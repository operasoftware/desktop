...
const AtomicString StyleEnvironmentVariables::GetVariableName(
  ...
  switch (variable) {
    ...
    case UADefinedVariable::kOperaGxAccentColorH:
      return AtomicString("-opera-gx-accent-color-h");
    case UADefinedVariable::kOperaGxAccentColorS:
      return AtomicString("-opera-gx-accent-color-s");
    case UADefinedVariable::kOperaGxAccentColorL:
      return AtomicString("-opera-gx-accent-color-l");
    case UADefinedVariable::kOperaGxAccentColorR:
      return AtomicString("-opera-gx-accent-color-r");
    case UADefinedVariable::kOperaGxAccentColorG:
      return AtomicString("-opera-gx-accent-color-g");
    case UADefinedVariable::kOperaGxAccentColorB:
      return AtomicString("-opera-gx-accent-color-b");
    case UADefinedVariable::kOperaGxBackgroundColor:
      return AtomicString("-opera-gx-background-color");
    case UADefinedVariable::kOperaGxBackgroundColorH:
      return AtomicString("-opera-gx-background-color-h");
    case UADefinedVariable::kOperaGxBackgroundColorS:
      return AtomicString("-opera-gx-background-color-s");
    case UADefinedVariable::kOperaGxBackgroundColorL:
      return AtomicString("-opera-gx-background-color-l");
    case UADefinedVariable::kOperaGxBackgroundColorR:
      return AtomicString("-opera-gx-background-color-r");
    case UADefinedVariable::kOperaGxBackgroundColorG:
      return AtomicString("-opera-gx-background-color-g");
    case UADefinedVariable::kOperaGxBackgroundColorB:
      return AtomicString("-opera-gx-background-color-b");
