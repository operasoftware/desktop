...
#define DEFINE_GPU_SHADER_RESOURCE_HISTOGRAM(prefix, name) \
  DEFINE_SINGLE_RESOURCE_HISTOGRAM(prefix, name)
#else
#define DEFINE_GPU_SHADER_RESOURCE_HISTOGRAM(prefix, name)
...
#define DEFINE_RESOURCE_HISTOGRAM(prefix)                      \
  switch (factory.GetType()) {                                 \
    ...
    DEFINE_GPU_SHADER_RESOURCE_HISTOGRAM(prefix, GpuShader)    \
  }
