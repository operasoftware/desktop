...
class WebServiceWorkerFetchContextImplTest : public testing::Test {
 public:
  ...
  class FakeURLLoaderThrottleProvider : public URLLoaderThrottleProvider {
    ...
    opera::content_filter::URLFilter* GetURLFilter() override {
      return nullptr;
    }
    bool MatchRulesAvailableEventID(uint32_t id) override { return false; }
    opera::content_filter::whitelist::State GetWhitelistedState(
        const GURL& url,
      base::optional_ref<const LocalFrameToken> local_frame_token,
        opera::content_filter::whitelist::TypeSet* types) override {
      return opera::content_filter::whitelist::State{};
    }
#endif  // OPERA_DESKTOP
  };
