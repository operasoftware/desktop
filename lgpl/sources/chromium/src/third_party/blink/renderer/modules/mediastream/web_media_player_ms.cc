...
WebMediaPlayer::LoadTiming WebMediaPlayerMS::Load(
  ...
  // The result of HasAudio() may have changed.
  client_->DidPlayerVolumeChange(
      HasAudio() ? volume_ : std::numeric_limits<double>::quiet_NaN());
...
void WebMediaPlayerMS::SetVolume(double volume) {
  ...
  client_->DidPlayerVolumeChange(HasAudio() ? volume : std::numeric_limits<double>::quiet_NaN());
}
