...
class MockMediaStreamAudioSink2 : public WebMediaStreamAudioSink {
 public:
  MockMediaStreamAudioSink2() {}
  ~MockMediaStreamAudioSink2() override {}
...
TEST_F(ProcessedLocalAudioSourceTest, VerifyAudioFlowWithoutAudioProcessing) {
  ...
  std::unique_ptr<MockMediaStreamAudioSink2> sink(
      new MockMediaStreamAudioSink2());
