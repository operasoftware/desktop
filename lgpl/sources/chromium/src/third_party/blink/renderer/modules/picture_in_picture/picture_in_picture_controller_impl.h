...
class MODULES_EXPORT PictureInPictureControllerImpl
 ...
 private:
  ...
  void TimeUpdateTimerFired(TimerBase*);
  ...
  // Drives media time updates in the Picture-in-Picture session.
  TaskRunnerTimer<PictureInPictureControllerImpl> time_update_timer_;
