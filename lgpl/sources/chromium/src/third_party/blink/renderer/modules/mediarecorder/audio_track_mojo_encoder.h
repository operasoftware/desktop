...
class MODULES_EXPORT AudioTrackMojoEncoder : public AudioTrackEncoder {
 public:
  ...
  void set_aac_options(std::optional<media::AudioEncoder::AacOptions> options) {
    aac_options_ = std::move(options);
  }
 ...
 private:
  ...
  std::optional<media::AudioEncoder::AacOptions> aac_options_;
