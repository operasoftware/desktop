...
// Heap compaction supports registering callbacks to be invoked when an
// object is moved during compaction, so as to support required internal
// location fixups.. i.e., when the object at |from| is copied to |to|.
using MovingObjectCallback = void (*)(void* data, void* from, void* to, size_t);
