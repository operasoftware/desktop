...
bool ThemePainterDefault::paintButton(const LayoutObject& o,
  ...
  extraParams.button.isDefault = false;
  extraParams.button.checked = false;
  extraParams.button.indeterminate = false;
  ...
  extraParams.button.hasFocus = LayoutTheme::isFocused(o);
