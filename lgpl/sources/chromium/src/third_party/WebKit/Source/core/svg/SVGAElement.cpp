...
bool SVGAElement::canStartSelection(
    SelectionStartPolicy selectionStartPolicy) const {
  if (!isLink() ||
      selectionStartPolicy == SelectionStartPolicy::DefaultAlsoForLinks)
    return SVGElement::canStartSelection(selectionStartPolicy);
