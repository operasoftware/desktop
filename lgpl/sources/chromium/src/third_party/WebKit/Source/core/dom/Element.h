...
class CORE_EXPORT Element : public ContainerNode {
 ...
 public:
  ...
  virtual void RequestDetachedView() {}
  virtual void ReleaseDetachedView() {}
  virtual bool HasDetachedView() { return false; }
  virtual bool IsVideoDetachAllowed() const { return false; }
  virtual void InvokeDetachedViewAction(const String& action) {}
  virtual void UpdateDetachedViewSubtitle(const String& text) {}
  virtual void RequestVRPlayback() {}
  virtual void ExitVRPlayback() {}
  virtual bool HasVRPlayback() { return false; }
  virtual bool IsVRPlaybackAllowed() { return false; }
